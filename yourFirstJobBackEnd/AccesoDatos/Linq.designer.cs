...
namespace yourFirstJobBackend.AccesoDatos
{
	...
	public partial class ObtenerTodasLasOfertasEmpleoResult
	{
		...
		private int _idArchivosEmpresa;
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_idArchivosEmpresa", DbType="Int NOT NULL")]
		public int idArchivosEmpresa
		{
			get
			{
				return this._idArchivosEmpresa;
			}
			set
			{
				if ((this._idArchivosEmpresa != value))
				{
					this._idArchivosEmpresa = value;
				}
			}
		}
